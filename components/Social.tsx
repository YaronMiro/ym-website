                    ...
                    return (
                        ...
                        >
                           <div className="flex items-center gap-1">
                                <div className={`flex justify-center items-center bg-primary text-accent text-3xl group-hover:bg-accent-hover group-hover:transition-all duration-1000 ease-in-out ${iconStyles}`}
                                >
                                    {icon}
                                </div>
                                <span className="hidden xl:flex capitalize ml-1  text-accent group-hover:text-accent-hover group-hover:transition-all duration-1000 ease-in-out">
                                    {name}
                                </span>
                           </div>
                        </Link>
